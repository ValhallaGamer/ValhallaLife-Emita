 ...
 */
R3F_REV_CFG_player_can_drag_body = false;
 ...
 */
R3F_REV_CFG_list_of_classnames_who_can_revive = ["KPFS_THW_Press","KPFS_THW_Worker","KPFS_THW_Worker_helmet","ibr_paramedic"];
