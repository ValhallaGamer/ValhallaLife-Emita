...

{
    ...
    {
    //if(escsave == 1)exitwith{player sideChat "You cannot Quick Save at this time, try again later.";};
    //escsave = 1;
    if(!INV_shortcuts)exitwith{};
    //player groupChat "Your stats will save in 10 seconds, please wait...";
    //sleep 10;
    [] execVM "quicksave.sqf";
    //player groupChat "You Cannot Quick Save for another 5 Minutes";
   // sleep 300;
    //escsave = 0;
    //player sideChat "Quick Saving is Available Again.";
    //sleep 2;
    };
