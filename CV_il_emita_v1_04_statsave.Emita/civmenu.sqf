...
while {true} do 
	...
	if (player Distance prison_logic >= 35 and player Distance prison_logic2 >= 50) exitWith {_exitart = "ausbruch"};
...
if ((_loopart == "arrest") and (player distance prisonflag2 <= 40))  then 
...
player setpos getmarkerpos "prisonspawn2";
