//Request & Load Stats
//Author: {ZAG}Ed!
server globalChat format["Loading Valhalla Gamer stats. Please wait...", loadRewardBonus];
...
server globalChat format["You are now synced with the EvolutionGaming database.", loadRewardBonus];
