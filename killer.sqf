...
if (iscop) then 
	...
	(format['if (player == %3)then{kontostand = kontostand + %2; player groupChat "You got 1/10 of the civs bounty totaling $%2"}', player, _civkopfgeld, _self]) call broadcast;
